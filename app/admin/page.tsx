...
const recentBookings = [
  { id: "BK-1041", guest: "Sarah Johnson", hotel: "Somerset Downtown", room: "Deluxe Suite", checkIn: "Apr 22, 2026", checkOut: "Apr 26, 2026", amount: "$1,240", status: "Confirmed" },
  { id: "BK-1040", guest: "Michael Chen", hotel: "Comfortable Villa Green", room: "Mansion Room", checkIn: "Apr 21, 2026", checkOut: "Apr 24, 2026", amount: "$890", status: "Checked In" },
  { id: "BK-1039", guest: "Emma Wilson", hotel: "4 Star Hotel", room: "Superior Room", checkIn: "Apr 20, 2026", checkOut: "Apr 22, 2026", amount: "$520", status: "Confirmed" },
  { id: "BK-1038", guest: "Raj Patel", hotel: "5 Star Hotel", room: "Rescue Room", checkIn: "Apr 19, 2026", checkOut: "Apr 23, 2026", amount: "$2,100", status: "Checked Out" },
  { id: "BK-1037", guest: "Amelia Brown", hotel: "Somerset Downtown", room: "Deluxe Suite", checkIn: "Apr 18, 2026", checkOut: "Apr 20, 2026", amount: "$620", status: "Cancelled" },
  { id: "BK-1036", guest: "Lucas Smith", hotel: "3 Star Hotel", room: "Mansion Room", checkIn: "Apr 17, 2026", checkOut: "Apr 19, 2026", amount: "$340", status: "Checked Out" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="flex items-end gap-3 h-36">
            {monthlyRevenue.map((m) => (
              <div key={m.month} className="flex-1 flex flex-col items-center gap-1.5">
                ...
                >
                  <div className="absolute -top-7 left-1/2 -translate-x-1/2 bg-dark-hover border border-dark-border text-white text-[10px] px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                    ${m.value}K
                  </div>
                  <div
                    className="absolute bottom-0 w-full rounded-t-md bg-gold"
                    style={{ height: "60%" }}
                  />
                </div>
        ...
        <div className="bg-dark-card border border-dark-border rounded-xl p-5">
          <h2 className="text-white font-semibold mb-4">Top Hotels</h2>
            ...
            {topHotels.map((hotel, i) => (
              <div key={hotel.name}>
                ...
                <div className="flex justify-between mt-1">
                  <span className="text-dark-muted text-[10px]">{hotel.bookings} bookings</span>
                  <span className="text-gold text-[10px] font-medium">{hotel.revenue}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {recentBookings.map((b, i) => (
                  <tr key={b.id} className={`border-b border-dark-border/50 hover:bg-dark-hover/50 transition-colors ${i === recentBookings.length - 1 ? "border-0" : ""}`}>
        ...
        <div className="bg-dark-card border border-dark-border rounded-xl overflow-hidden">
          ...
          <div className="divide-y divide-dark-border/50">
            {recentReviews.map((r) => (
              <div key={r.guest + r.hotel} className="px-5 py-4 hover:bg-dark-hover/50 transition-colors">
