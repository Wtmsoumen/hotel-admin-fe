    ...
    <header className="h-16 shrink-0 border-b border-dark-border bg-dark-card flex items-center px-6 gap-4">
      ...
      <div className="relative hidden sm:block">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="pl-9 pr-4 py-2 bg-dark border border-dark-border rounded-lg text-sm text-white placeholder-dark-muted focus:outline-none focus:border-gold transition-colors w-52"
        />
      </div>
